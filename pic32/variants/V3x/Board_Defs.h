...
#define	_BOARD_NAME_	"Hestia V3x"
#define _USB
...
*/
static const uint8_t SS   = 88;		// for SPI master operation, shared with pin 16
static const uint8_t MOSI = 89;		// PIC32 SDO2
static const uint8_t MISO = 90;		// PIC32 SDI2
static const uint8_t SCK  = 91;		// PIC32 SCK2

/* The Digilent DSPI library uses these ports.
*/
#define	PIN_DSPI0_SS	88      // SS2; W25Q128
#define	PIN_DSPI1_SS	38      // SS1; 
#define	PIN_DSPI2_SS	92      // SS3; W5500
//#define	PIN_DSPI3_SS	43      // SS4;
//#define	PIN_DSPI6_SS	15      // SS6; 
...
#define	_SER0_IPL       4
#define	_SER0_SPL       0
#define _SER0_TX_OUT    PPS_OUT_U4TX     
#define _SER0_TX_PIN    97              // RF8              
#define _SER0_RX_IN     PPS_IN_U4RX      
#define _SER0_RX_PIN    98              // RF2  
...
#define _SER1_TX_PIN    64               // RF5
#define _SER1_RX_IN     PPS_IN_U1RX
#define _SER1_RX_PIN    65               // RF4
...
#define _SER2_TX_PIN    74                // RD2
#define _SER2_RX_IN     PPS_IN_U3RX
#define _SER2_RX_PIN    75                // RD3

/* Serial3 UART2 PIC32MX 
*/
...
#define _SER3_TX_PIN    99               // RE8
#define _SER3_RX_IN     PPS_IN_U2RX
#define _SER3_RX_PIN    100               // RE9

/* Serial4 UART5 LCD/HMI
*/
...
#define _SER4_TX_PIN    68               // RG0
#define _SER4_RX_IN     PPS_IN_U5RX
#define _SER4_RX_PIN    69               // RG1
...
#define _SER5_TX_PIN    71               // RD12
#define _SER5_RX_IN     PPS_IN_U6RX
#define _SER5_RX_PIN    72               // RD1
...
#define _DSPI0_MISO_PIN		90		    // RB3
#define _DSPI0_MOSI_OUT		PPS_OUT_SDO2
#define _DSPI0_MOSI_PIN		89	    // RB5
...
#define _DSPI2_MISO_PIN		94		    // RB9
#define _DSPI2_MOSI_OUT		PPS_OUT_SDO3
#define _DSPI2_MOSI_PIN		93		    // RB10
...
/* The standard I2C port uses I2C4 (SCL4/SDA4).
** 
*/
...
#define	_DTWI0_IPL		3
#define	_DTWI0_SPL		0
#define _DTWI0_SCL_PIN  83 
#define _DTWI0_SDA_PIN  82 
...
#define	_DTWI1_IPL		3
#define	_DTWI1_SPL		0
#define _DTWI1_SCL_PIN  80 
#define _DTWI1_SDA_PIN  79 
...
#define	PIN_W5500_RST   96 // RH8
#define PIN_SPI_SS_ETHERNET_LIB 92 // RB15 SS3

#define PIN_SPIFLASH_SS  88 //RC2 SS2
