...
#define	PIN_LQ_OE	    49 // RB12
#define	PIN_IN1 	    44 // RB11
#define	PIN_IN2 	    62 // RA1
#define	PIN_IN3         65 // RF13

#define	PIN_WOK_DIR     70 // RA7
#define	PIN_WOK_PUL     26 // RE0
#define	PIN_WOK_ENA     27 // RE1
...
#define	PIN_AUX_DIR     67 // RG13
#define	PIN_AUX_PUL     28 // RE2
#define	PIN_AUX_ENA     29 // RE3
#define	PIN_AUX_FAULT   30 // RE4
...
#define	PIN_ROT_EN      10 // RG9
#define	PIN_ROT_DIR     19 // RG8
#define	PIN_ROT_FAULT   18 // RG7

#define	PIN_VALVE1_EN   25 // RB0
#define	PIN_VALVE1_STAT 23 // RB1

#define	PIN_VALVE2_EN   41 // RA9
#define	PIN_VALVE2_STAT 63 // RA0

#define	PIN_SER5_DE     42 // RA10
#define	PIN_SER2_DE     22 // RB4

#define	PIN_HEATER_EN   47 // RA4

#define	PIN_SER4_DE     66 // RA6
